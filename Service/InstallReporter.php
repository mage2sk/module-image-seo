<?php
/**
 * Standalone install + heartbeat reporter for Panth_ImageSeo.
 *
...
namespace Panth\ImageSeo\Service;
...
{
    public const MAGENTO_MODULE = 'Panth_ImageSeo';
    public const COMPOSER_PACKAGE = 'mage2kishan/module-image-seo';
